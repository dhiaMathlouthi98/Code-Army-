...
class UserController extends AbstractController
{
    ...
    public function home(Request $request)
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            $us = $propertySearch->getUsern();
            if (($nom != "")) {
                $User = $this->getDoctrine()->getRepository(User::class)->findBy(['nom' => $prenom]);
            }
            else
                $User = $this->getDoctrine()->getRepository(User::class)->findAll();
        }
    ...
    public function new(Request $request,\Swift_Mailer $mailer) {
        ...
        $form = $this->createFormBuilder($user)
            ...
            ->add('Role', ChoiceType::class, ['choices'  => ['Enseignant' => 'Enseignant', 'Admin' => 'Admin',],])
